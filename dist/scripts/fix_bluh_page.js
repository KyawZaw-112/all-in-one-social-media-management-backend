...
async function resubscribePage() {
    ...
    try {
        const unsub = await axios.delete(`https://graph.facebook.com/v21.0/${BLUH_PAGE_ID}/subscribed_apps`, { params: { access_token: token } });
    ...
    try {
        const sub = await axios.post(`https://graph.facebook.com/v21.0/${BLUH_PAGE_ID}/subscribed_apps`, null, {
            params: {
                access_token: token,
    ...
    try {
        const verify = await axios.get(`https://graph.facebook.com/v21.0/${BLUH_PAGE_ID}/subscribed_apps`, { params: { access_token: token } });
