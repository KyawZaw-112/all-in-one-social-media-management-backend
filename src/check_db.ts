...
async function checkSchema() {
    ...
    if (ordersErr) console.error("❌ Error selecting from orders:", ordersErr);
    else if (ordersData && ordersData.length > 0) console.log("Orders columns:", Object.keys(ordersData[0]));
}
